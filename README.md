...
Use help followed by the function name if you need assistance with any MATLAB function. You’ll only need the first two columns.
...
This way, while the T wave may cross the threshold, because it occurs too close to the R wave, it won’t be counted.
